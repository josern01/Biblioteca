...
public class Ventana1 extends JFrame {
    ...
    private int x = 60;
    private int y = 60;
    private int direction = 1; // 1 para mover de izquierda a derecha, -1 para mover de derecha a izquierda
    ...
    public Ventana1() {
        ...
        this.setLayout(null);
         ...
         //PANEL ANIMADO
        container = new JPanel();  // Crea un contenedor principal
        container.setLayout(null);
        container.setBounds(20, 20, 420, 380);
        container.setBackground(color2);
        this.add(container);  // Agrega el contenido
        agregarPaneles(container);
        ...
        timer = new Timer(10, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (direction == 1) {
                    x += 1; // Incrementa la posición X para mover de izquierda a derecha
                } else {
                    x -= 1; // Decrementa la posición X para mover de derecha a izquierda
                }

                container.setLocation(x, 20);
                repaint();

                if (x >= 350) {
                    direction = -1; // Cambia la dirección para mover de derecha a izquierda
                } else if (x <= 20) {
                    direction = 1; // Cambia la dirección para mover de izquierda a derecha
                }
            }
        });
           ...
           addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                // No necesitamos implementar esto, pero es necesario para KeyListener
            }
        ...
        setFocusable(true); // Para que el JFrame reciba eventos del teclado
        requestFocus(); // P
...
//        pan89.setBounds(20, 20, 420, 380);     //TODO EL DIBUJO
//        this.add(pan89);
...
//
//        timer = new Timer(10, new ActionListener() {
//            int x = 0;  // Inicializa la posición X
//
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                x += 1;  // Incrementa la posición X
//                container.setLocation(x, 20);  // Actualiza la posición del contenedor
//                repaint();
//
//                if (x >= 420) {
//                    timer.stop();  // Detiene la animación cuando alcanza el límite deseado
//                }
//            }
//        });
//
//        timer.start();
    ...
    private void agregarPaneles(JPanel container) {
